          ...
          <div className="animate-in fade-in slide-in-from-right-4 duration-300">
            ...
            <CardContent className="space-y-4">
              <div className="bg-muted/50 p-4 rounded-lg text-sm text-muted-foreground space-y-3 h-56 overflow-y-auto border border-border">
                ...
                <p><strong>2. Data Privacy & AI Processing:</strong> Your data is encrypted and shared only with your assigned coach. Food descriptions and photos you log may be sent to third-party nutrition analysis services (including automated and AI-assisted tools) to estimate nutritional content. This data is processed securely and externally, and no personal identifiers are included in these requests.</p>
                <p><strong>3. AI-Powered Features:</strong> This app uses automated and AI-assisted analysis to estimate macronutrient content from your meals. By agreeing below, you consent to your food log data being processed by third-party nutrition analysis services for this purpose. You may decline AI analysis at any time and enter nutritional data manually.</p>
